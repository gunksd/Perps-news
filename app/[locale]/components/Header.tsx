          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 hidden sm:block">
                {currentLocale === 'zh' ? 'AI驱动的金融新闻分析 • 实时追踪市场动态' : 'AI-Powered Financial News Analysis • Real-time Market Tracking'}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-green-50 dark:bg-green-900/20 rounded-full">
              ...
              <span className="text-xs font-medium text-green-700 dark:text-green-400">
                {currentLocale === 'zh' ? '实时更新' : 'Live'}
              </span>
            </div>

            {/* Export Button */}
            <ExportButton locale={currentLocale} />

            {/* Language Switcher */}
            <button
              onClick={switchLocale}
              className="px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md transition flex items-center gap-1"
